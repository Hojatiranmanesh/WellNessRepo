...
const Breath = () => {
    ...
    const questions = [
        ...
        {
            text: 'در این مرحله؛ محلی با مشخصات زیر طراحی شود: \n 5 روز برای وارد کردن اطلاعات غذایی فرد در نظر گرفته شود.در هریک از روزها، امکان اضافه کردن تاریخ، ماده غذایی مصرف شده و در نهایت مقدار حدودی آن وجود داشته باشد.',
            options: [],
        },
        {
