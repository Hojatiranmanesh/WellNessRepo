    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 20:
          ...
          _context.next = 28;
          return regeneratorRuntime.awrap(fetch("https://api.hamyarwellness.com/api/v1/notifs/", {
            method: "POST",
        ...
        case 31:
          ...
          console.log("Sending Push...");
          _context.next = 36;
          return regeneratorRuntime.awrap(fetch("https://api.hamyarwellness.com/api/v1/subscribe", {
            method: "POST",
